layui.config({
    ...
    $(".btn").click(function(){
    	...
    	for (var i = 0; i < goods.length; i++) {
    		var obj = new Object();
			var inport = synAjax("GET", '/v0.1/inport/select/group?goodsName='+goods[i].goodsName+'&time='+time, null, '查询失败!');
    ...
    function tab(res){
    	table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'inportNumber', title: '进货总数量'}
                ,{field: 'goodsUnit', title: '单位'}
                ,{field: 'inportPrice', title: '进货总价格（元）'}
            ]]
            ,data:res
         });
    }
